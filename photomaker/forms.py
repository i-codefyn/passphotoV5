...
class PassPhotoMakerForm(forms.ModelForm):
    class Meta:
        model = PhotoMaker
        fields = ('file',)
    ...
    def __init__(self, *args, **kwargs):
        super(PassPhotoMakerForm, self).__init__(*args, **kwargs)
...
class PhotoForm(forms.ModelForm):
    ...
    def save(self, commit=False):
        ...
        # img = cropped_image.resize((int(1.3 * 300), int(1.6 * 300)), Image.Resampling.LANCZOS)
        ...
        # im.convert("RGB")
        image.save('passphotooo.jpg', "jpeg")
        return photo
